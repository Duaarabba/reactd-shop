...
export default function Order() {
  ...
  const formik= useFormik({
    initialValues,
    onSubmit,
    validationSchema:OrderPassScheam,
  })
...
return (
    ...
    <div className="row mt-5">
            <h2 className='text-Color'>Have a coupon ?</h2>
     ...
     <button type="submit"  className="  px-5 py-3 rounded-2 border text-white bg-mainColor" >Send</button>
